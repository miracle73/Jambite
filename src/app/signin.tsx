                ...
                <View style={{ paddingHorizontal: 20, justifyContent: "center", flex: 1, }}>
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                style={[styles.transitionButton, !isSignIn && { backgroundColor: "#FFFFFF" }]}
                                onPress={() => { setIsSignIn(true); router.push("/signin") }}
                            >
                                <Text style={[styles.secondText, { color: isSignIn ? "white" : "#0F065E" }]}>Sign In</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[styles.transitionButton, isSignIn && { backgroundColor: "#FFFFFF" }]}
                                onPress={() => { setIsSignIn(false); router.push("/signup") }}
                            >
                                <Text style={[styles.secondText, { color: !isSignIn ? "white" : "#0F065E" }]}>Sign up</Text>
                            </TouchableOpacity>
                        ...
                        <View>
                            <Text style={[styles.fourthText, { marginTop: 10 }]}>Forgot password</Text>
                        </View>
